...
echo "$minutes minutos se passaram desde o inicio do dia.";
...
$numberCDU = readline("Digite um numero no formato CDU: \n");

$reversed = strrev($numberCDU);
...
$result = ($hundred * 1) + ($ten * 2) + ($unit * 3);


$verifyDigit = $result % 10;

echo "Digito verificador: $verifyDigit \n";
*/